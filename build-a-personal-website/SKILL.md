...
Fill in `name`, `tagline`, `photo`, `socials`. For colors and fonts, offer the Style Kit choices in `reference/style-kit.md` — text auto-sits readably on whatever accent they pick. If unsure, keep the default beige/lime/Geist.
